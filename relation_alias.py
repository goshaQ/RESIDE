...
def main(args):
    ...
    def get_probable_rel(rel_phrs):
        ...
        dist = cdist(phr_embed, alias_embed,
                     metric=args.metric)  # Computing similarity between given phrases and relation aliases from KG
        rels = set()
