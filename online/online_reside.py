...
class RESIDE(Base):
    ...
    def create_feed_dict(self, batch, wLabels=False, split='test'):  # Where putting dropout for train?
        X, pos1, pos2, sent_num, sub_type, obj_type, rel_alias = batch['X'], batch['Pos1'], batch['Pos2'], batch[
            'sent_num'], batch['SubType'], batch['ObjType'], batch['ProbY']
...
if __name__ == "__main__":
    ...
    parser.add_argument('-max_pos', dest="max_pos", default=60, type=int,
                        help='Maximum position difference to consider')
    ...
    parser.add_argument('-rel2alias_file',
                        default='./side_info/relation_alias/riedel/relation_alias_from_wikidata_ppdb_extended.json',
                        help='File containing relation alias information')
    parser.add_argument('-type2id_file', default='./side_info/entity_type/riedel/type_info.json',
                        help='File containing entity type information')
